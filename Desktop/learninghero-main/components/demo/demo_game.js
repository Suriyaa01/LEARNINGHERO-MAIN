...
export default class demo_game extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.ground0 = new SpritePlatform(this.gameCanvas, 0, 62, 100, 8, "rect", 'rgba(255, 255, 255, 0.5)','rgba(255, 255, 255, 0)')
    ...
    // this.handPointer = new SpriteDrawing(this.gameCanvas, 20, 20, 5, 10, "fontawesome_hand-pointer-solid", 'rgba(0, 255, 0, 1)', "gray")

    // this.text1 = new SpriteText(this.gameCanvas, 10,10, "hello")
  ...
  handleClick(event)  {
    ...
    console.log('collisionList',collisionList)
